...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://ruoyi.vip', null, '', 0, 0, 'M', '0', '0', '', 'BranchesOutlined',    'admin', sysdate(), '', null, '若依官网地址');

insert into sys_menu values('5', '控制台', 0, 0, 'dashboard', NULL, NULL, 1, 0, 'M', '1', '0', NULL, 'AppstoreOutlined', 'admin', sysdate(), '', NULL, '');
insert into sys_menu values('6', '个人', 0, 0, 'account', NULL, NULL, 1, 0, 'M', '1', '0', NULL, 'ProfileOutlined', 'admin', sysdate(), '', NULL, '');

-- 二级菜单
insert into sys_menu values('11', '数据分析', 5, 0, 'analysis', NULL, NULL, 1, 0, 'C', '1', '0', NULL, '#', 'admin', sysdate(), '', NULL, '数据分析');
insert into sys_menu values('12', '个人中心', 6, 0, 'center', NULL, NULL, 1, 0, 'C', '1', '0', NULL, '#', 'admin', sysdate(), '', NULL, '个人中心');
insert into sys_menu values('13', '设置', 6, 0, 'settings', NULL, NULL, 1, 0, 'C', '1', '0', NULL, '#', 'admin', sysdate(), '', NULL, '设置');


insert into sys_menu values('100',  '用户管理', '1',   '1', 'user',       'system/user/index',        '', 1, 0, 'C', '0', '0', 'system:user:list',        'UserOutlined',          'admin', sysdate(), '', null, '用户管理菜单');
insert into sys_menu values('101',  '角色管理', '1',   '2', 'role',       'system/role/index',        '', 1, 0, 'C', '0', '0', 'system:role:list',        'ProfileOutlined',              'admin', sysdate(), '', null, '角色管理菜单');
insert into sys_menu values('102',  '菜单管理', '1',   '3', 'menu',       'system/menu/index',        '', 1, 0, 'C', '0', '0', 'system:menu:list',        'MenuUnfoldOutlined',    'admin', sysdate(), '', null, '菜单管理菜单');
...
insert into sys_menu values('106',  '参数设置', '1',   '7', 'config',     'system/config/index',      '', 1, 0, 'C', '0', '0', 'system:config:list',      'ProfileOutlined',          'admin', sysdate(), '', null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告', '1',   '8', 'notice',     'system/notice/index',      '', 1, 0, 'C', '0', '0', 'system:notice:list',      'NotificationOutlined',       'admin', sysdate(), '', null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理', '1',   '9', 'log',        '',                         '', 1, 0, 'M', '0', '0', '',                        'BlockOutlined',           'admin', sysdate(), '', null, '日志管理菜单');
insert into sys_menu values('117',  '字典数据', '1',   '10', 'dict-data', 'system/dictData/index',    '', 1, 0, 'C', '1', '0', 'system:dict:list',        'FolderAddOutlined', 'admin', sysdate(), '', null, '字典数据管理菜单');
...
insert into sys_menu values('114',  '表单构建', '3',   '1', 'build',      'tool/builder/index',         '', 1, 0, 'C', '0', '0', 'tool:build:list',         'BlockOutlined',         'admin', sysdate(), '', null, '表单构建菜单');
insert into sys_menu values('115',  '代码生成', '3',   '2', 'gen',        'tool/gen/index',           '', 1, 0, 'C', '0', '0', 'tool:gen:list',           'PrinterOutlined',          'admin', sysdate(), '', null, '代码生成菜单');
insert into sys_menu values('116',  '系统接口', '3',   '3', 'swagger',    'tool/swagger/index',       '', 1, 0, 'C', '0', '0', 'tool:swagger:list',       'ApiOutlined',       'admin', sysdate(), '', null, '系统接口菜单');
...
insert into sys_menu values('501',  '登录日志', '108', '2', 'logininfor', 'monitor/logininfor/index', '', 1, 0, 'C', '0', '0', 'monitor:logininfor:list', 'HddOutlined',    'admin', sysdate(), '', null, '登录日志菜单');
-- 用户管理按钮
